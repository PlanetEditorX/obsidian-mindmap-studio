...
test("global search indexes and displays only node text without submap metadata", () => {
  ...
  assert.doesNotMatch(source, /mms-global-search-result-badges|mms-global-search-result-file/);
  ...
  assert.doesNotMatch(styles, /mms-global-search-badge|mms-global-search-result-path/);
});
