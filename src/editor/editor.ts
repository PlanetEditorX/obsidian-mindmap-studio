...
import { articleTocDepth, buildArticleNodeInfo, DISPLAY_MODE_ICONS, DISPLAY_MODE_LABELS, readingAnchorPart, resolveArticleContextProgressPercent, resolveArticleTocMaxDepth, type ArticleContextProgress, type ArticleTocEntry } from "../article/modes";
