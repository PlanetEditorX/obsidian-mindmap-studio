...
#countdown{position:fixed;left:50%;bottom:24px;transform:translateX(-50%);z-index:11;display:none;min-width:58px;padding:9px 18px;border-radius:999px;background:rgba(8,17,28,.9);border:1px solid rgba(75,190,255,.65);box-shadow:0 10px 30px rgba(0,0,0,.38),0 0 22px rgba(33,160,230,.22);color:#fff;font-size:28px;font-weight:750;text-align:center;letter-spacing:.2px;pointer-events:none;backdrop-filter:blur(12px)}#countdown.show{display:block}
