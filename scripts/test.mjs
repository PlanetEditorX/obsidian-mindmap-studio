...
| 梨 | 2 | 进行中 |`;
  ...
  assert.match(settingsSource, /"主题与外观", "视图与阅读", "编辑与交互", "节点布局与尺寸", "工具栏", "快捷键配置"/, "settings categories must use the curated default order without a separate code-behavior section");
  ...
  assert.match(articleRendererSource, /const pageEntry = isDocumentArticleNumberingDisabled\(options\.document\.root\)[\s\S]*currentArticlePageEntry\(options\.articleNavigation\)[\s\S]*mms-article-number[\s\S]*mms-article-document-title-text/, "child article pages must render the generated number before the editable root title unless the current document disables numbering");
