...
`);
  ...
  assert.match(circledHtml, /<p class="body-paragraph">① 要点 1<\/p>/, "HTML export must use native circled Unicode for the first fifty terminal nodes");
  assert.match(circledHtml, /<span class="circled-number">51<\/span> 要点 51/, "HTML export must draw a circle around terminal numbers after 50");
