...
`);
  ...
  assert.match(exportedWordXml, /<w:hyperlink w:anchor="export-0-mindmap-article-/, "exported Word documents must use internal TOC hyperlinks");
  assert.match(exportedWordXml, /<w:bookmarkStart w:id="\d+" w:name="export-0-mindmap-article-[^"]+"\/><w:r>[\s\S]*?<\/w:r><w:bookmarkEnd/, "exported Word bookmarks must wrap their target heading text");
