...
| 梨 | 2 | 进行中 |`;
  ...
  assert.match(cssSource, /\.mms-reading-progress\.position-bottom[\s\S]*top:\s*calc\(100% - 40px\)/);
  assert.match(cssSource, /@media \(max-width:\s*1180px\)[\s\S]*\.mms-reading-progress\.position-left/);
