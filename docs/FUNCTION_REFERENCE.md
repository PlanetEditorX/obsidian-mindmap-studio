...
### 接口 `ArticleIncrementalRenderOptions`

源码：`src/editor/article-renderer.ts:44`
...
源码：`src/editor/article-renderer.ts:54`
...
源码：`src/editor/article-renderer.ts:92`
...
源码：`src/editor/article-renderer.ts:246`

Returns a cache only when it belongs to the current file and presentation contract.

```ts
function compatibleArticleCache( snapshot: ArticleRenderCacheSnapshot | null, filePath: string, presentationFingerprint: string ): ArticleRenderCacheSnapshot | null
```

### 函数 `articlePresentationFingerprint`

源码：`src/editor/article-renderer.ts:260`
...
源码：`src/editor/article-renderer.ts:282`

A moved, renumbered, restyled, or edited node receives a different fingerprint.

```ts
function articleNodeFingerprint( info: ReturnType<typeof buildArticleNodeInfo>[number], options: ArticleRendererOptions ): string
```

### 函数 `isArticleNodeCacheable`

源码：`src/editor/article-renderer.ts:306`
...
源码：`src/editor/article-renderer.ts:311`

Restores safe static HTML immediately; interactive behavior is hydrated in a later frame.

```ts
function restoreCachedArticleSection( section: HTMLElement, html: string, info: ReturnType<typeof buildArticleNodeInfo>[number], options: ArticleRendererOptions ): boolean
```
...
源码：`src/editor/article-renderer.ts:348`

Binds the current editor instance to one restored static node without rebuilding its visible DOM.

```ts
function hydrateArticleNodeSection( section: HTMLElement, info: ReturnType<typeof buildArticleNodeInfo>[number], options: ArticleRendererOptions ): void
```

### 函数 `hydrateArticleNodeContent`

源码：`src/editor/article-renderer.ts:401`
...
源码：`src/editor/article-renderer.ts:454`
...
源码：`src/editor/article-renderer.ts:457`
...
源码：`src/editor/article-renderer.ts:470`
...
源码：`src/editor/article-renderer.ts:475`

Reconnects resize and edit behavior to a table restored from cached HTML.

```ts
function hydrateArticleTable( wrap: HTMLElement, node: MindMapNode, tableData: MindMapTable, blockId: string, options: ArticleRendererOptions ): void
```
...
源码：`src/editor/article-renderer.ts:535`
...
源码：`src/editor/article-renderer.ts:595`
...
源码：`src/editor/article-renderer.ts:608`
...
源码：`src/editor/article-renderer.ts:613`
...
源码：`src/editor/article-renderer.ts:620`
...
源码：`src/editor/article-renderer.ts:631`
...
源码：`src/editor/article-renderer.ts:649`
...
源码：`src/editor/article-renderer.ts:742`
...
源码：`src/editor/article-renderer.ts:809`
...
源码：`src/editor/article-renderer.ts:851`
...
源码：`src/editor/editor-modals.ts:249`
...
源码：`src/editor/editor-modals.ts:353`
...
源码：`src/editor/editor-modals.ts:361`
...
源码：`src/editor/editor-modals.ts:371`

创建文章样式编辑器。

```ts
constructor( app: App, style: ArticleStyle | undefined, private readonly globalLeafPresentation:
```

### 方法 `ArticleStyleModal.onOpen`

源码：`src/editor/editor-modals.ts:384`
...
源码：`src/editor/editor-modals.ts:502`
...
```ts
constructor( app: App, private readonly document: MindMapDocument, private readonly onImport: (document: MindMapDocument, mode: "child" | "replace") => void, private readonly onExport: (json: string) => void, private readonly getLastImportFolder: () => stri…
```

### 方法 `JsonTransferModal.onOpen`

源码：`src/editor/editor-modals.ts:526`
...
源码：`src/editor/editor-modals.ts:654`
...
源码：`src/editor/editor-modals.ts:662`
...
源码：`src/editor/editor-modals.ts:669`
...
源码：`src/editor/editor-modals.ts:690`
...
源码：`src/editor/editor-modals.ts:698`
...
源码：`src/editor/editor-modals.ts:705`
...
源码：`src/editor/editor-modals.ts:712`
...
源码：`src/editor/editor-types.ts:31`
...
源码：`src/editor/editor-types.ts:75`
...
### 方法 `MindMapEditor.maintainPendingArticleLocation`
...
### 方法 `MindMapEditor.claimProgressiveArticleViewport`
...
### 方法 `MindMapEditor.revealArticleRender`

源码：`src/editor/editor.ts:3333`
...
### 方法 `MindMapEditor.maintainArticleRenderViewport`
...
### 方法 `MindMapEditor.completeArticleRender`
...
### 方法 `MindMapEditor.cancelArticleRender`
...
### 方法 `MindMapEditor.beginArticleRender`

源码：`src/editor/editor.ts:3857`
...
源码：`src/editor/node-actions.ts:89`
...
源码：`src/editor/node-actions.ts:96`
...
源码：`src/editor/outline-renderer.ts:120`
...
源码：`src/editor/question-modal.ts:27`
...
源码：`src/editor/question-modal.ts:66`
...
源码：`src/editor/question-modal.ts:96`
...
源码：`src/editor/question-modal.ts:108`
...
源码：`src/editor/question-modal.ts:114`
...
源码：`src/editor/question-modal.ts:172`
...
源码：`src/editor/question-modal.ts:192`
...
源码：`src/editor/question-modal.ts:214`
...
源码：`src/editor/question-practice-mode.ts:41`
...
源码：`src/editor/question-practice-mode.ts:46`
...
源码：`src/editor/question-practice-mode.ts:200`
...
源码：`src/editor/question-practice-mode.ts:228`
...
源码：`src/editor/question-practice-mode.ts:236`
...
源码：`src/editor/question-practice-mode.ts:243`
...
源码：`src/editor/question-practice-mode.ts:250`
...
源码：`src/editor/question-practice-mode.ts:257`
...
源码：`src/editor/question-practice-mode.ts:268`
...
源码：`src/editor/question-practice-mode.ts:279`
...
源码：`src/editor/question-practice-mode.ts:307`
...
源码：`src/editor/question-practice-mode.ts:336`
...
源码：`src/editor/question-practice-mode.ts:348`
...
源码：`src/editor/question-practice-mode.ts:353`
...
源码：`src/editor/question-practice-mode.ts:358`
...
源码：`src/editor/question-practice-mode.ts:363`
...
源码：`src/editor/rich-text-dom.ts:117`
...
源码：`src/editor/rich-text-dom.ts:129`
...
源码：`src/editor/rich-text-dom.ts:165`
...
源码：`src/editor/table-interaction.ts:36`
...
源码：`src/editor/table-interaction.ts:52`
...
源码：`src/import/import-export.ts:111`
...
源码：`src/import/import-export.ts:158`
...
源码：`src/import/import-export.ts:174`
...
源码：`src/import/import-export.ts:225`
...
源码：`src/import/import-export.ts:303`
...
源码：`src/import/import-export.ts:375`
...
### 方法 `MindMapStudioPlugin.getArticleRenderCache`
...
### 方法 `MindMapStudioPlugin.updateArticleRenderCache`
...
### 函数 `prioritizeArticleNodeIds`

源码：`src/render/incremental-render.ts:123`
