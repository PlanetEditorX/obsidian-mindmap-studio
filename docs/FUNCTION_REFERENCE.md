...
源码：`src/editor/article-renderer.ts:154`
...
源码：`src/editor/article-renderer.ts:177`
...
源码：`src/editor/article-renderer.ts:195`
...
源码：`src/editor/article-renderer.ts:269`
...
### 方法 `MindMapEditor.bindArticleContentBlockMoveControl`
...
### 方法 `MindMapEditor.moveArticleContentBlockByKeyboard`
...
```ts
private moveArticleContentBlockByKeyboard( sourceNodeId: string, blockId: string, key: "ArrowUp" | "ArrowDown" | "ArrowLeft" | "ArrowRight" ): void
```

### 方法 `MindMapEditor.moveContentBlock`

源码：`src/editor/editor.ts:4802`
