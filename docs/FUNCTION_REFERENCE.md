...
源码：`src/utils/plugin-update.ts:21`
...
源码：`src/utils/plugin-update.ts:27`
...
源码：`src/utils/plugin-update.ts:35`
...
### 函数 `findPluginInstallAsset`

源码：`src/utils/plugin-update.ts:48`
...
源码：`src/utils/plugin-update.ts:60`
