...
图片预览弹窗内的一次来源变更请求。 `reupload` 表示选择本地图片并上传图床（图床与手动 URL 来源）；`replaceLocal` 表示选择本地 图片替换本地副本；`remove` 删除一个来源（没有任何剩余来源时由宿主删除整个图片块）； `add` 把用户手动填写的 URL 添加为新来源；`setDefault` / `unsetDefault` 写入或取消图片级来源优先级。
...
源码：`src/editor/editor-modals.ts:146`
...
源码：`src/editor/editor-modals.ts:161`
...
源码：`src/editor/editor-modals.ts:173`
...
源码：`src/editor/editor-modals.ts:180`
...
源码：`src/editor/editor-types.ts:97`
...
源码：`src/editor/node-edit-modal.ts:26`
...
源码：`src/editor/node-edit-modal.ts:51`
...
源码：`src/editor/node-edit-modal.ts:75`
...
源码：`src/editor/node-edit-modal.ts:96`
...
源码：`src/editor/node-edit-modal.ts:639`
...
源码：`src/editor/node-edit-modal.ts:652`
...
源码：`src/utils/desktop-capture.ts:443`
...
源码：`src/utils/desktop-capture.ts:455`
...
源码：`src/utils/desktop-capture.ts:477`
...
源码：`src/utils/desktop-capture.ts:497`
...
源码：`src/utils/desktop-capture.ts:618`
...
源码：`src/utils/desktop-capture.ts:645`
...
源码：`src/utils/desktop-capture.ts:666`
...
源码：`src/utils/desktop-capture.ts:758`
...
源码：`src/utils/desktop-capture.ts:805`
...
源码：`src/utils/desktop-capture.ts:819`
