...
```ts
async function openWindowsPinnedCapture( nodeRuntime: NodeCaptureRuntime, bytes: Uint8Array, bounds:
```
...
```ts
async function openPinnedCapture( nodeRuntime: NodeCaptureRuntime, bytes: Uint8Array, bounds:
```
